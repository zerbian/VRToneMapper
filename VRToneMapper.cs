...
public sealed class VRToneMapper : CustomPostProcessVolumeComponent, IPostProcessComponent
{
    ...
    public enum ToneMappingOperatorType : int
    {
        ...
        [InspectorName("Reinhard without Gaze")]
        Reinhard,
    ...
    /// </summary>
    [Tooltip("Center point of the gaze point")]
    public Vector2Parameter m_GazeCenter = new Vector2Parameter(new Vector2(0.5f, 0.5f));
    ...
    /// </summary>
    [Tooltip("")]
    public FloatParameter m_LuminanceScale = new FloatParameter(1.0f);

    public FloatParameter m_TargetLuminance = new FloatParameter(1.0f);
    ...
    public override void Render(CommandBuffer cmd, HDCamera camera, RTHandle source, RTHandle destination)
    {
        ...
        m_Material.SetVector("_GazeCenter", m_GazeCenter.value);
        m_Material.SetFloat("_Sigma", m_Sigma.value);
        m_Material.SetFloat("_AdaptationScale", m_AdaptationScale.value);
        m_Material.SetFloat("_LuminanceKey", m_LuminanceScale.value);
        m_Material.SetFloat("_TargetLuminance", m_TargetLuminance.value);
